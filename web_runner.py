"""
Pipeline runner with progress hooks for the Streamlit web UI.
...
class StreamingLLMProxy(BaseChatModel):
    """
    Wraps a real MLXChatModel to intercept stream() calls and push tokens
    to a callback, so the Streamlit UI can display them live.
    """
